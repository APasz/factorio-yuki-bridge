...
local function bridge_say(raw)
  ...
  game.print({"", "[Yuki/", speaker, "] ", message})
...
commands.add_command("yuki", "Yuki bridge command: say/evolution", function(command)
  ...
  rcon.print("Usage: /yuki say Speaker|message | /yuki evolution [force]")
end)
...
script.on_event(defines.events.on_player_died, function(event)
  ...
  emit("player_died", {
    ...
    position = player and player.position and {
      x = player.position.x,
      y = player.position.y
    } or nil,
